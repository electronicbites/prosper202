...
//only create a new list if there is no post
	if (($_POST['order']== '') and ($_POST['offset'] == '')) {
		...
		//delete old text_ad list
			$mysql['user_id'] = mysql_real_escape_string($_SESSION['user_id']);
			$text_ad_sql = "DELETE FROM `202_sort_text_ads_lpctr` WHERE `user_id`='".$mysql['user_id']."'";
...
// Add Clickthroughs and CTR for each keyword
				//click throughs
					$click_throughs = 0;
...
// Clean escape characters from strings
					$mysql['sort_text_ad_click_throughs'] = mysql_real_escape_string($total_click_throughs);
					$mysql['sort_text_ad_ctr'] = mysql_real_escape_string($total_ctr_ratio);
				...
				//insert the data
					$text_ad_sort_sql = "INSERT INTO 202_sort_text_ads_lpctr
										 SET         user_id='".$mysql['user_id']."',
													 text_ad_id='".$mysql['text_ad_id']."',
													 sort_text_ad_clicks='".$mysql['sort_text_ad_clicks']."',

													 sort_text_ad_click_throughs='".$mysql['sort_text_ad_click_throughs']."',
													 sort_text_ad_ctr='".$mysql['sort_text_ad_ctr']."',
...
$html['sort_text_ad_click_throughs_order'] = 'sort_text_ad_click_throughs asc';
if ($_POST['order'] == 'sort_text_ad_click_throughs asc') {
	$html['sort_text_ad_click_throughs_order'] = 'sort_text_ad_click_throughs desc';
	$mysql['order'] = 'ORDER BY `sort_text_ad_click_throughs` DESC';
} elseif ($_POST['order'] == 'sort_text_ad_click_throughs desc') {
	$html['sort_text_ad_click_throughs_order'] = 'sort_text_ad_click_throughs asc';
	$mysql['order'] = 'ORDER BY `sort_text_ad_click_throughs` ASC';
}

$html['sort_text_ad_ctr_order'] = 'sort_text_ad_ctr asc';
if ($_POST['order'] == 'sort_text_ad_ctr asc') {
	$html['sort_text_ad_ctr_order'] = 'sort_text_ad_ctr desc';
	$mysql['order'] = 'ORDER BY `sort_text_ad_ctr` DESC';
} elseif ($_POST['order'] == 'sort_text_ad_ctr desc') {
	$html['sort_text_ad_ctr_order'] = 'sort_text_ad_ctr asc';
	$mysql['order'] = 'ORDER BY `sort_text_ad_ctr` ASC';
}
...
<table cellspacing="0" cellpadding="0" style="width: 100%; font-size: 12px;">
	<tr>
		<td width="100%;">
			<a target="_new" href="/tracking202/analyze/text_ads_lpctr_download.php">
...
<table cellpadding="0" cellspacing="1" class="m-stats">
	<tr>
		<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_text_ads_lpctr.php','','<? echo $html['sort_text_ad_text_ad_order']; ?>');">Text Ad</a></th>
		<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_text_ads_lpctr.php','','<? echo $html['sort_text_ad_clicks_order']; ?>');">Clicks</a></th>
		<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_text_ads_lpctr.php','','<? echo $html['sort_text_ad_click_throughs_order']; ?>');">Click Throughs</a></th>
		<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_text_ads_lpctr.php','','<? echo $html['sort_text_ad_ctr_order']; ?>');">LP CTR</a></th>
		<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_text_ads_lpctr.php','','<? echo $html['sort_text_ad_leads_order']; ?>');">Leads</a></th>
		<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_text_ads_lpctr.php','','<? echo $html['sort_text_ad_su_ratio_order']; ?>');">S/U</a></th>
		<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_text_ads_lpctr.php','','<? echo $html['sort_text_ad_payout_order']; ?>');">Payout</a></th>
		<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_text_ads_lpctr.php','','<? echo $html['sort_text_ad_epc_order']; ?>');">EPC</a></th>
		<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_text_ads_lpctr.php','','<? echo $html['sort_text_ad_avg_cpc_order']; ?>');">Avg CPC</a></th>
		<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_text_ads_lpctr.php','','<? echo $html['sort_text_ad_income_order']; ?>');">Income</a></th>
		<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_text_ads_lpctr.php','','<? echo $html['sort_text_ad_cost_order']; ?>');">Cost</a></th>
		<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_text_ads_lpctr.php','','<? echo $html['sort_text_ad_net_order']; ?>');">Net</a></th>
		<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_text_ads_lpctr.php','','<? echo $html['sort_text_ad_roi_order']; ?>');">ROI</a></th>
	</tr>
...
while ($text_ad_row = mysql_fetch_array($text_ad_result, MYSQL_ASSOC)) {
	...
	$html['sort_text_ad_click_throughs'] = htmlentities($text_ad_row['sort_text_ad_click_throughs'], ENT_QUOTES, 'UTF-8');
	$html['sort_text_ad_ctr'] = htmlentities($text_ad_row['sort_text_ad_ctr'], ENT_QUOTES, 'UTF-8');
	...
	<tr>
		...
		<td class="m-row1"><? echo $html['sort_text_ad_click_throughs']; ?></td>
		<td class="m-row1"><? echo $html['sort_text_ad_ctr']; ?></td>
...
<? if ($query['pages'] > 2) { ?>
	<div class="offset">   <?
		if ($query['offset'] > 0) {
			printf(' <a class="onclick_color" onclick="loadContent(\'/tracking202/ajax/sort_text_ads_lpctr.php\',\'%s\',\'%s\');">First</a> ', $i, $html['order']);
			printf(' <a class="onclick_color" onclick="loadContent(\'/tracking202/ajax/sort_text_ads_lpctr.php\',\'%s\',\'%s\');">Prev</a> ', $query['offset'] - 1, $html['order']);
		}
		...
		if ($query['pages'] > 1) {
			for ($i=0; $i < $query['pages']-1; $i++) {
				if (($i >= $query['offset'] - 10) and ($i < $query['offset'] + 11)) {
					...
					printf(' <a %s onclick="loadContent(\'/tracking202/ajax/sort_text_ads_lpctr.php\',\'%s\',\'%s\');">%s</a> ', $class, $i, $html['order'], $i+1);
					unset($class);
				}
			}
		}
		...
		if ($query['offset'] < $query['pages'] - 2) {
			printf(' <a class="onclick_color" onclick="loadContent(\'/tracking202/ajax/sort_text_ads_lpctr.php\',\'%s\',\'%s\');"">Next</a> ', $query['offset'] + 1, $html['order']);
			printf(' <a class="onclick_color" onclick="loadContent(\'/tracking202/ajax/sort_text_ads_lpctr.php\',\'%s\',\'%s\');">Last</a> ', $query['pages'] - 2, $html['order']);
		} ?>
	</div>
<? } ?>
