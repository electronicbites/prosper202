...
if ($_SERVER ['REQUEST_METHOD'] == 'POST') {
	...
	$aff_campaign_type = trim ( $_POST ['$aff_campaign_type'] );
	if ($aff_campaign_type == '0'){
	...
	if (! $error) {
		$mysql ['aff_campaign_id'] = mysql_real_escape_string ( $_POST ['aff_campaign_id'] );
		$mysql ['aff_network_id'] = mysql_real_escape_string ( $_POST ['aff_network_id'] );
		$mysql ['aff_campaign_type'] = mysql_real_escape_string ( $_POST ['aff_campaign_type'] );
		...
		$aff_campaign_sql .= "`aff_network_id`='" . $mysql ['aff_network_id'] . "',
													  ...
													  `aff_campaign_type`='" . $mysql ['aff_campaign_type'] . "',
...
<div id="info">
<h2>***NEW*** Affiliate Campaign Setup</h2>
...
<table cellspacing="3" cellpadding="3" class="setup">
	<tr valign="top">
		...
		<table>
			...
			<tr>
				...
				<td style="white-space: nowrap;"><input type="text"
					name="aff_campaign_url"
					value="<?
					echo $html ['aff_campaign_url'];
					?>"
		...
		<script type="text/javascript">
				...
				var asset_url = is_ssl ? "https://ads.tracking202.com/prosper202-sponsoredaffnetwork/" : "<?php
				echo TRACKING202_ADS_URL;
				?>/prosper202-sponsoredaffnetwork/";
